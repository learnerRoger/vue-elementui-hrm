<template>
  <div class="manage">
    ...
    <div style="margin-bottom: 10px">
      ...
      <el-upload :action="uploadApi" :headers="headers" :multiple="false" :show-file-list="false"
        :on-success="handleUploadSuccess" :limit="1" style="display:inline-block;margin-left: 10px">
        <el-button type="primary" size="mini">上传 <i class="el-icon-circle-plus-outline"></i>
        </el-button>
      </el-upload>
    ...
    <div class="common-table">
      <el-table :data="table.tableData" height="85%" border stripe row-key="id" fit :header-cell-style="{background: '#eef1f6',color: '#606266',
